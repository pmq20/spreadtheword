...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Automatic release note generator, with integrations with Wrike and GitLab.}
  spec.description   = %q{Automatic release note generator, with integrations with Wrike and GitLab.}
